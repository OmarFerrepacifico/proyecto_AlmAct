...
<script type="text/javascript">
		function btnMinformacion(){
			...
			$.get("reportes/reporte/tablahistorial_clientes.php",{fechainicial:fechainicial,fechafinal:fechafinal,vendedor:nombre,sucursal:sucursal,puesto:puesto,mes:meses,cliente:cliente},function(htmlexterno){$("#mostrartabla").html(htmlexterno);});
			delay();
