...
<div class="row" >
	...
	<h4 style="text-align:center"><strong>REPORTE DE DISPONIBILIDAD PARA VENTA</strong></h4>
...
<script type="text/javascript">
		function btnMinformacion(){
				...
				$.get("reportes/reporte/tablainventario.php",{a:"a"},function(htmlexterno){$("#mostrartabla").html(htmlexterno);});
