...
<div class="row" >
	...
	<h4 style="text-align:center"><strong>REPORTE DE COMISIÓN DE JEFES DE SUCURSAL</strong></h4>
...
<script type="text/javascript">
		function btnMinformacion(){
			...
			if (f1[1]!=f2[1]) {
				...
				$.get("reportes/reporte/tablacomisionjefedesucursal.php",{fechainicial:fechainicial,fechafinal:fechafinal,vendedor:nombre,sucursal:sucursal,puesto:puesto},function(htmlexterno){$("#mostrartabla").html(htmlexterno);});
				delay();
