...
$obj = clientes([ "consulta" => "articulos_clasificacion","sucursal" =>$_GET['a'],"clasificacion" => $_GET['clasificacion']]);
$obj=json_decode($obj);
?>
<style>
    .tablas{
...
<table class="display nowrap table table-sm table-bordered table-hover table-responsive-sm" style="text-align: center; width:100%" id="mydatatable" >
	...
	<tbody >
		...
		?>
                <tr>
                    <td style="text-align:left;font-size:15px"><?php echo $clientes1[$ii]->{'displayname'}; ?></td>
                    ...
                    <td style="text-align:right"><?php echo "$".number_format(($clientes1[$ii]->{'valor_de_stock'}),2) ?></td>
