	...
	<tbody >
		...
		?>
                <tr>
                    ...
                    <td style="text-align:right"><?php echo number_format($clientes1[$ii]->{'fondeport'},2) ?></td>
                    <td style="text-align:right"><?php echo number_format($clientes1[$ii]->{'cantamar'},2) ?></td>
                    <td style="text-align:right"><?php echo number_format(($clientes1[$ii]->{'melaque'}),2) ?></td>
                    <td style="text-align:right"><?php echo number_format($clientes1[$ii]->{'huerta'},2) ?></td>
                    <td style="text-align:right"><?php echo number_format(($clientes1[$ii]->{'mayoreo'}),2) ?></td>
                    <td style="text-align:right"><?php echo number_format($clientes1[$ii]->{'villa'},2) ?></td>
                    <td style="text-align:right"><?php echo number_format($clientes1[$ii]->{'tlaquepaque'}, 2); ?></td>
 	...
 	$(document).ready(function(){
		$('#mydatatable').DataTable({
            ...
            "footerCallback": function (row, data, start, end, display) {
				...
				$(api.column(1).footer()).html("<b></b>" + $.fn.dataTable.render.number(",", ".", 2, "").display(pageTotal1) + "</b> "); 
				...
				// Update footer
						...
						$(api.column(5).footer()).html(" <b>" + $.fn.dataTable.render.number(",", ".", 2, "").display(pageTotal5) + "</b> ");
                // Total over this page
						pageTotal5 = api
