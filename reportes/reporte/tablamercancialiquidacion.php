...
$obj = clientes([ "consulta" => "mercancia_liquidacion","sucursal" =>$_GET['a']]);
$obj=json_decode($obj);
?>
<style>
    .tablas{
...
<table class="display nowrap table table-sm table-bordered table-hover table-responsive-sm" style="text-align: center; width:100%" id="mydatatable" >
	<thead >
		<tr>
			...
			<th>COSTO POR PIEZA MAS IVA</th>
			<th>TOTAL DINERO ANTES DE IVA CF</th>
			<th>TOTAL DINERO ANTES DE IVA CD</th>
		</tr>
	</thead>
	<tbody >
		<?php 
		...
		?>
                <tr>
                    ...
                    <td style="text-align:left;font-size:15px"><?php echo $clientes1[$ii]->{'solucion'}; ?></td>
                    <td style="text-align:left;font-size:15px"><?php echo $clientes1[$ii]->{'grupo'}; ?></td>
                    <td style="text-align:left;font-size:15px"><?php echo $clientes1[$ii]->{'linea'}; ?></td>
                    <td style="text-align:left;font-size:15px"><?php echo $clientes1[$ii]->{'sublinea'}; ?></td>
                    <td style="text-align:right"><?php echo number_format($clientes1[$ii]->{'cantidad_fisica'}, 0); ?></td>
                    <td style="text-align:right"><?php echo number_format($clientes1[$ii]->{'cantidad_disponible'}, 0); ?></td>
                    <td style="text-align:right">$<?php echo number_format($clientes1[$ii]->{'costo_por_pieza_mas_iva'}, 2); ?></td>
                    <td style="text-align:right">$<?php echo number_format($clientes1[$ii]->{'total_d_a_iva_cf'}, 2); ?></td>
                    <td style="text-align:right">$<?php echo number_format($clientes1[$ii]->{'total_d_a_iva_cd'}, 2); ?></td>
