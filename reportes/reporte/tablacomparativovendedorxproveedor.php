...
$obj = clientes([ "consulta" => "comparativomarca","f_ini" => date('d/m/Y',strtotime($_GET['fechainicial'])),"f_fin" => date('d/m/Y',strtotime($_GET['fechafinal'])),"vendedor" => $vendedor,"sucursal"=>$sucursal]);
$obj=json_decode($obj);
?>
<style>
    .tablas{
		...
		$('#mydatatable').DataTable({
            ...
            "footerCallback": function (row, data, start, end, display) {
				...
				// Update footer
						...
						$(api.column(7).footer()).html(" <b>" + $.fn.dataTable.render.number(",", ".", 2, "").display((pageTotal4/pageTotal3)*100) + "%</b> ");
            }
        });
