...
<div class="row" >
	...
	<h4 style="text-align:center"><strong>REPORTE DE CLASIFICACIÓN DE ARTICULOS</strong></h4>
	<div class="d-flex bd-highlight">
		...
		<h5 class="m-2 font-weight-bold"><strong>CLASIFICACIÓN</strong></h5>
		<div class="p-1 flex-fill bd-highlight">
			<select class="form-control input-sm" name="meses" id="meses">
				<option>A</option>
				<option>B</option>
				<option>C</option>
				<option value="TL">TOP LOW</option>
				<option value="AN">ARTICULOS NUEVOS</option>
			</select>
		</div>
		<div class="p-1 flex-fill bd-highlight">
...
<script type="text/javascript">
		function btnMinformacion(){
				...
				$.get("reportes/reporte/tablaarticulosclasificacion.php",{a:sucursal,clasificacion:meses},function(htmlexterno){$("#mostrartabla").html(htmlexterno);});
