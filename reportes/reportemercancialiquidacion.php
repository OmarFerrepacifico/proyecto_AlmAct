...
<div class="row" >
	...
	<h4 style="text-align:center"><strong>REPORTE DE MERCANCIA DE LIQUIDACIÓN</strong></h4>
...
<script type="text/javascript">
		function btnMinformacion(){
				...
				$.get("reportes/reporte/tablamercancialiquidacion.php",{a:sucursal},function(htmlexterno){$("#mostrartabla").html(htmlexterno);});
