...
<div class="row" >
	...
	<h4 style="text-align:center"><strong>REPORTE DE PROYECCIÓN DE PROVEEDORES</strong></h4>
	<div class="d-flex bd-highlight">
		...
		<h5 class="m-2 font-weight-bold"><strong>MESES A PROMEDIAR</strong></h5>
		<div class="p-1 flex-fill bd-highlight">
...
<script type="text/javascript">
		function btnMinformacion(){
			...
			if (f1[1]!=f2[1]) {
				...
				$.get("reportes/reporte/tablaproyeccionproveedores.php",{fechainicial:fechainicial,fechafinal:fechafinal,vendedor:nombre,sucursal:sucursal,puesto:puesto,mes:meses},function(htmlexterno){$("#mostrartabla").html(htmlexterno);});
				delay();
